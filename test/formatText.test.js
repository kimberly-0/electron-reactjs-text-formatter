...
test('returns empty string if column options are set to not keep any', () => {
    const columnOptions = [''];
    expect(formatText('text', 'kbdb', columnOptions)).toEqual('');
})
...
test('formats text with source Compuclub correctly with most common options', () => {
    ...
    expect(formatText(textCompuclub, 'compuclub', columnOptionsCompuclub, '', 'overal', 'overal', 0)).toEqual(result);
})
...
test('formats text with source KBDB correctly with most common options', () => {
    ...
    expect(formatText(textKbdb, 'kbdb', columnOptionsKbdb, '', 'overal', 'overal', 0)).toEqual(result);
})
...
test('formats text with source Compuclub correctly with full text options adjusted', () => {
    ...
    expect(formatText(textCompuclub, 'compuclub', columnOptionsCompuclub, '', 'eerste', 'eerste', 3)).toEqual(result);
})
...
test('formats text with source KBDB correctly with full text options adjusted', () => {
    ...
    expect(formatText(textKbdb, 'kbdb', columnOptionsKbdb, '', 'eerste', 'eerste', 4)).toEqual(result);
})
...
test('formats text with source Compuclub correctly without city (gemeente)', () => {
    ...
    expect(formatText(textCompuclub, 'compuclub', columnOptionsCompuclubWithoutCity, '', 'overal', 'overal', 0)).toEqual(result);
})
...
test('formats text with source KBDB correctly without city (gemeente)', () => {
    ...
    expect(formatText(textKbdb, 'kbdb', columnOptionsKbdbWithoutCity, '', 'overal', 'overal', 0)).toEqual(result);
})
...
test('formats text and keeps city and speed on all lines with invalid full text options', () => {
    ...
    expect(formatText(textKbdb, 'kbdb', columnOptionsKbdb, '', 'invalid', 'invalid', 'invalid')).toEqual(result);
})

test('keeps columns for which invalid column options are provided ... ...', () => {
    const columnOptions = ['invalid'];
    expect(formatText('text', 'compuclub', columnOptions)).toBe('text.');
})
...
test('keeps columns for which invalid column options are provided ... ...', () => {
    ...
    expect(formatText(textCompuclub, 'compuclub', columnOptions)).toBe(result);
})